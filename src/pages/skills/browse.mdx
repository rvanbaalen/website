...
metaDescription: "A Claude Code skill that gives Claude a fast headless browser for QA testing, dogfooding, and visual verification: snapshots, screenshots, and assertions."
version: "1.1.0"
