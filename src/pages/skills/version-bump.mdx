...
metaDescription: "A Claude Code skill that auto-suggests semver version bumps for changed plugins in a Claude Code marketplace before pushing, catching drift between manifests."
version: "1.1.0"
