...
metaDescription: "A Claude Code skill that turns your session's changes into clean, atomic micro-commits with conventional commit messages, grouping related files together."
version: "1.4.0"
