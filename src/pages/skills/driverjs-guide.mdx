...
metaDescription: "A Claude Code skill and reference for building product tours, onboarding flows, and element highlighting with Driver.js, from install to full config options."
version: "1.1.0"
