...
metaDescription: "A Claude Code skill that creates a GitHub issue from the terminal with guided template, issue type, and label selection, then drafts a title and body to match."
version: "1.1.0"
