...
metaDescription: "A Claude Code agent plugin that acts as a delivery-focused project manager: it enforces deadlines, tracks estimates against actuals, and detects drift early."
version: "2.0.1"
