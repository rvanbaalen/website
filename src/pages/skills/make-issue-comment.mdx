...
metaDescription: "A Claude Code skill that posts and maintains structured investigation comments on GitHub PRs, capturing root cause, fix plan, and verification in one place."
version: "0.2.0"
