...
metaDescription: "A Claude Code skill that stress-tests a plan, spec, or RFC interview-style before any code is written, walking the design tree one question at a time."
version: "0.1.0"
