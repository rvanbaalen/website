...
metaDescription: "A Claude Code skill that commits, pushes, reviews, and cuts a release in one fire-and-forget command, running the whole pipeline in a background agent."
version: "1.2.0"
