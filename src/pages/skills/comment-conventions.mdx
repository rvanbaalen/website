...
metaDescription: "A Claude Code skill with language-agnostic rules for code comments and docblocks, applied on every source-code edit to keep comments terse and current."
version: "0.9.0"
