...
metaDescription: "A Claude Code skill with eight principles for designing and reviewing user interfaces, from purpose and agency to restraint, with trade-offs named out loud."
version: "0.1.0"
