...
metaDescription: "A Claude Code skill for TanStack Query v5 with three modes: review existing code, migrate from v4 to v5, and get coding guidance, every rule cited to the docs."
version: "2.0.0"
