...
metaDescription: "A Claude Code skill that reclaims macOS disk space through a safety-tiered identify, propose, execute flow, using tool-native cleaners instead of raw deletes."
version: "0.1.0"
