...
metaDescription: "A Claude Code skill that sets up and deploys Astro sites to Cloudflare Workers with custom domains, using git-based deploys instead of local wrangler deploy."
version: "0.1.0"
