...
I built this with Fable 5. It did the research, wrote the Go and set up the releases; I steered the direction and caught it when it went wrong. A weekend side project that turned out genuinely usable.
