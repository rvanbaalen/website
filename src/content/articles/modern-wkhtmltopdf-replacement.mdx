...
I'll tell you the one thing I can't fix, because it's physics, not a bug: leaving a 2011 engine changes how pages look. Blink measures text differently, and there's no more "smart shrinking" quietly resizing things to fit. Your documents will move a little. So the migration is: replace the binary, put the old and new PDFs side by side, and re-approve your templates. That's it. That's the whole migration. Next to rewriting a production PDF layer, it's a rounding error.
